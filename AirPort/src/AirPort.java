...
public class AirPort extends JFrame{
    ...
    private ArrayList horizontal, vertical;                    //listy do wyjazdu
    private ArrayList horizontalStart, verticalStart;          //listy przed odlotem
...
//                            newFlota();
    ...
    public class plane{
        ...
        private boolean     parked;     //czy zaparkował
